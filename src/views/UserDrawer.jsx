...
// Slide-over body for a single identity. Rendered inside <Drawer/>, which
// supplies the close button and scrim.
    ...
    <>
      <div className="drawer-h">
        ...
        <div className="hrow" style={{ paddingBottom: 14, borderBottom: '1px solid var(--hair)' }}>
          <button className="btn btn-sec btn-sm"><Icon name="edit" />Edit</button>
          ...
          <button className="btn btn-sec btn-sm" onClick={() => toast('ok', 'Password reset', 'Reset link issued via verified channel (demo).')}><Icon name="refresh" />Reset password</button>
