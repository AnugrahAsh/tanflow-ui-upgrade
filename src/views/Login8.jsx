...
/* The plain sign-in page (/login8).

   No artwork, no globe — the real Tanflow wordmark over a single centred card.
   The form itself is the one from Login.jsx: same fields, same validation, same
   attempt counter and lockout, so behaviour matches the primary surface.
  ...
  return (
    <div className="l8">
      <main className="l8-in">
        {/* The panel stays plain on purpose — the visual interest lives in the
            page texture behind it, not in chrome inside the card. */}
        <form className="l8-card" onSubmit={signIn} noValidate>
          <div className="l8-body">
            ...
            <div className="field">
              <label htmlFor="l8-user">Username<span className="lg-req"> *</span></label>
              <input
                id="l8-user"
                className="inp"
            ...
            <div className="field">
              <label htmlFor="l8-pass">Password<span className="lg-req"> *</span></label>
