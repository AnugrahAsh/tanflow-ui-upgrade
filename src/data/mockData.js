...
// ── Logged-in user profile (My Profile / Edit Profile) ─────────────────────
export const PROFILE = {
  name: 'Anika Rao',
  handle: 'anika_rao',
  initials: 'AR',
  avatarColor: '#22A45D',
  email: 'anika.rao@meridianbank.com',
  role: 'Global Security Admin',
  organization: 'Meridian Global Bank',
  phone: '+44 7700 900321',
  timezone: 'Server Default',
  status: 'Active',
  passwordValidity: 'Valid',
  passwordChange: 'Allowed',
  dailyAccess: 'Unrestricted',
  validFrom: 'No start date',
  validUntil: 'No expiry',
  roles: ['ADMIN'],
  groups: ['Security Engineering', 'SOC Tier-2 Analysts', 'Domain Admins'],
  connections: [
    { name: 'BTSIDAMDB01', proto: 'PGSQL', icon: 'db' },
    { name: 'BTSPLAPAM01', proto: 'SSH', icon: 'commands' },
    { name: 'BTSSAPWINPOC01', proto: 'RDP', icon: 'sessions' },
    { name: 'HRMS APPLICATION', proto: 'WEB-APP', icon: 'globe' },
    { name: 'MySQL', proto: 'MYSQL', icon: 'db' },
    { name: 'MYSQL WORKBENCH', proto: 'DB-CLIENT', icon: 'db' },
  ],
}
